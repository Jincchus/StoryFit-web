...
import { RESPONSE_CONTROL_RULES, NOVEL_RESPONSE_CONTROL_RULES, STORY_RESPONSE_CONTROL_RULES } from '@/lib/responseControl'
...
- 선택지는 반드시 유저(${personaName})의 다음 행동이나 대사 후보여야 합니다.
