...
[언어 규칙 — 절대 준수]
반드시 한국어로만 응답하세요. 영어를 포함한 다른 언어 사용을 금지합니다. 대화 길이나 내용과 무관하게 항상 한국어로만 작성합니다.`
...
- 반드시 한국어로만 작성하세요.
⚠️ 절대 금지: 이름 없이 "대사만 단독으로 쓰는 것". 장면 안에서 ${personaName}이 말하는 대사도 반드시 ${personaName} : "내용" 형식으로 작성하세요.
