...
export async function getGlobalConfigValue(
  key: 'whif_session_cookie' | 'whif_persona_id' | 'melting_session_cookie' | 'melting_session_nickname' | 'tingle_auth_token' | 'tingle_refresh_token' | 'tingle_firebase_api_key' | 'zeta_token' | 'zeta_refresh_token' | 'tikita_session_token' | 'crack_session_cookie'
): Promise<string> {
