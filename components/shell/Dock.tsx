...
const TABS = [
  ...
  },
  {
    ...
    isActive: (p: string) => p === '/explore' || p.startsWith('/whif') || p.startsWith('/zeta') || p.startsWith('/melting') || p.startsWith('/tikita') || p.startsWith('/chub') || p.startsWith('/rofan') || p.startsWith('/loveydovey') || p.startsWith('/characters'),
  },
  {
