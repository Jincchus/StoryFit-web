...
export const PRESET_CHARS: Character[] = [
  {
    id: 'luna', kind: 'wizard', name: '루나', title: '별빛 마법사',
  ...
  {
    id: 'caelum', kind: 'knight', name: '카엘룸', title: '성기사단장',
  ...
  {
    id: 'shade', kind: 'rogue', name: '셰이드', title: '그림자 도둑',
  ...
  {
    id: 'mei', kind: 'maid', name: '메이', title: '저택의 메이드',
  ...
  {
    id: 'vela', kind: 'vampire', name: '벨라', title: '천 년 묵은 흡혈귀',
  ...
  {
    id: 'orion', kind: 'ai', name: '오리온', title: '우주선 AI',
  ...
  {
    id: 'saera', kind: 'elf', name: '사에라', title: '숲의 궁수',
  ...
  {
    id: 'kuro', kind: 'ninja', name: '쿠로', title: '잠입의 달인',
