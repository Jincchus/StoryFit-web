      ...
      <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
        <div className="lovey-scroll">
          <div className="lovey-cover-wrap">
            {col.coverImageUrl ? <ZoomableImage className="lovey-cover" src={col.coverImageUrl} alt="" /> : <div className="lovey-cover" />}
          ...
          <div className="lovey-section">
            <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginBottom: 10 }}>
              {mainChar?.avatarUrl
                ? <ZoomableImage className="lovey-avatar" src={mainChar.avatarUrl} alt="" />
              ...
              <div style={{ minWidth: 0, flex: 1 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
                    ...
                    <button className="lovey-chip" style={{ border: 'none', cursor: 'pointer', background: 'var(--l-surface-2)', padding: '4px 8px', fontSize: 11 }}
                      onClick={() => router.push(`/characters/new?isLoveydovey=true&collectionId=${col.id}`)}>+ 캐릭터 등록</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <MappedCharacters characters={col.characters} prefix="l" personaName={userDisplayName} />
