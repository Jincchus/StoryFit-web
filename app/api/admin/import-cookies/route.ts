...
const KEYS = ['whif_session_cookie', 'whif_persona_id', 'melting_session_cookie', 'melting_session_nickname', 'babechat_access_token', 'babechat_refresh_token', 'tingle_auth_token', 'tingle_refresh_token', 'tingle_firebase_api_key', 'zeta_token', 'rofan_session_cookie', 'tikita_session_token'] as const
