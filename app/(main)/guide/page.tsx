...
const FEATURE_SECTIONS: FeatureSection[] = [
  ...
  },
  {
    title: '📥 외부 센터 가져오기',
    items: [
      { emoji: '🔗', label: 'URL 붙여넣기 가져오기', desc: 'WHIF·ZETA·melting·Tikita·Chub·rofanai·loveydovey 센터의 캐릭터/스토리 URL을 각 센터 ⋮ 메뉴에 붙여넣으면 캐릭터·첫 장면·설정을 자동으로 가져옵니다.' },
  ...
  },
  {
    ...
    items: [
      ...
      { emoji: '🏷', label: '센터 태그·제목 검색', desc: 'WHIF·ZETA·melting·Tikita·Chub·rofanai·loveydovey 센터에서 태그 칩을 눌러 작품/캐릭터를 좁히고, 검색창에 제목·이름을 입력해 빠르게 찾을 수 있습니다.' },
  ...
  },
  {
    ...
    items: [
      ...
      { emoji: '★', label: '센터 즐겨찾기', desc: 'WHIF·ZETA·melting·Tikita·Chub·rofanai·loveydovey 센터에서 카드의 ★를 눌러 즐겨찾기하고, 즐겨찾기 탭에서 모아볼 수 있습니다. 기기 간 동기화됩니다.' },
