...
const FEATURE_SECTIONS: FeatureSection[] = [
  ...
  },
  {
    title: '🛠 내 커맨드 & AI 폴백',
    items: [
      { emoji: '⚡', label: '커스텀 AI 커맨드 (내 커맨드)', desc: '대화 설정 > "내 커맨드"에서 "+ 새 커맨드"로 `!에타` 같은 나만의 슬래시 커맨드를 만들 수 있습니다. 저장된 커맨드는 목록에서 펼쳐(아코디언) 내용을 수정하거나 삭제할 수 있고, 모든 대화에서 재사용되며 AI 응답은 마크다운으로 렌더링됩니다.' },
