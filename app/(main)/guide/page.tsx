...
const FEATURE_SECTIONS: FeatureSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { emoji: '🎨', label: '스타일 설정', desc: '시점·시제·분위기·문체·응답 길이·전개 속도를 선택해 대화 톤을 세밀하게 조정합니다. (AI응답 탭)' },
  ...
  },
  {
    ...
    items: [
      ...
      { emoji: '🗂', label: '내 캐릭터 필터·정렬·검색', desc: '캐릭터 페이지에서 센터별로 필터링하고 최신순·오래된순·가나다순으로 정렬할 수 있습니다. 🔍 검색을 눌러 캐릭터명·카드(세계관)명으로 찾거나, 태그 탭에서 등록된 태그 목록을 골라 좁힐 수 있습니다.' },
