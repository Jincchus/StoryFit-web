    ...
    <>
      ...
      {searchOpen && (
        <>
          ...
          <TagFilterBar groups={tagGroups} selected={selectedTags} onToggle={toggleTag} onClear={() => setSelectedTags([])} chipClass="bc-chip" accentVar="--b-accent" counts={tCounts} storageKey="bc_tagcollapse" />
        </>
      )}
